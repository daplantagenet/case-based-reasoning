...
#'
#' Regression beta coefficients obtained from a linear regression model fitted on the 
...
#'   object of this class \code{LinearBetaModel}. Formula for analysis has to be 
#'   provided.}
