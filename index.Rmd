...
The **Similarity**-package contains the C++-distance calculation functions for this package. The compilation should work on Ubuntu and Mac OS X out-of-the-box. On Windows you need g++ verion 4.9.3 or greater (Windows- Binary: [Similarity_0.1.zip](Similarity/Similarity_0.1.zip)).
